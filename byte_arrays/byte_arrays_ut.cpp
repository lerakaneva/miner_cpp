...
template <typename T>
class HexDataTest : public ::testing::Test {
protected:
...
TEST_F(BytesTest, CreateWithHexString) {
    ...
    Verify(Bytes(ODD_LENGTH_STRING), ODD_LENGTH_STRING_NORM, ODD_LENGTH_NUMBER_LITTLE_ENDIAN);
    Verify(Bytes(SMALL_NUMBER_STRING), SMALL_NUMBER_STRING_NORM, SMALL_NUMBER_LITTLE_ENDIAN);
    Verify(Bytes("00000" + SMALL_NUMBER_STRING), SMALL_NUMBER_STRING_NORM, SMALL_NUMBER_LITTLE_ENDIAN);
    Verify(Bytes(BIG_NUMBER_STRING), BIG_NUMBER_STRING_NORM, BIG_NUMBER_LITTLE_ENDIAN);
}

TEST_F(BytesTest, CreateWithHexStringAndSize) {
    Verify(Bytes(SMALL_NUMBER_STRING, 3), SMALL_NUMBER_STRING_NORM, SMALL_NUMBER_LITTLE_ENDIAN);
    Verify(Bytes(SMALL_NUMBER_STRING, 8), SMALL_NUMBER_STRING_EIGTH, SMALL_NUMBER_LITTLE_ENDIAN_EIGTH);
...
TEST_F(BytesTest, CreateWithData) {
    ...
    Verify(Bytes(ODD_LENGTH_NUMBER_LITTLE_ENDIAN), ODD_LENGTH_STRING_NORM, ODD_LENGTH_NUMBER_LITTLE_ENDIAN);
    Verify(Bytes(SMALL_NUMBER_LITTLE_ENDIAN), SMALL_NUMBER_STRING_NORM, SMALL_NUMBER_LITTLE_ENDIAN);
    Verify(Bytes(BIG_NUMBER_LITTLE_ENDIAN), BIG_NUMBER_STRING_NORM, BIG_NUMBER_LITTLE_ENDIAN);
}
...
TEST_F(Ui32Test, CreateWithHexString) {
    ...
    Verify(Ui32(ODD_LENGTH_STRING), ODD_LENGTH_STRING_UI32, ODD_LENGTH_NUMBER_LITTLE_ENDIAN_UI32);
    Verify(Ui32(SMALL_NUMBER_STRING), SMALL_NUMBER_STRING_UI32, SMALL_NUMBER_LITTLE_ENDIAN_UI32);
    Verify(Ui32("00000" + SMALL_NUMBER_STRING), SMALL_NUMBER_STRING_UI32, SMALL_NUMBER_LITTLE_ENDIAN_UI32);

    EXPECT_DEATH(Ui32{BIG_NUMBER_STRING}, ".*");
}

TEST_F(Ui32Test, CreateWithData) {
    Verify(Ui32(ZERO_LITTLE_ENDIAN_UI32), ZERO_STRING_UI32, ZERO_LITTLE_ENDIAN_UI32);
    Verify(Ui32(ODD_LENGTH_NUMBER_LITTLE_ENDIAN_UI32), ODD_LENGTH_STRING_UI32, ODD_LENGTH_NUMBER_LITTLE_ENDIAN_UI32);
    Verify(Ui32(SMALL_NUMBER_LITTLE_ENDIAN_UI32), SMALL_NUMBER_STRING_UI32, SMALL_NUMBER_LITTLE_ENDIAN_UI32);
...
TEST_F(Ui32Test, Sums) {
    ...
    Bytes num_3 = num_1 + num_2;
    EXPECT_EQ(num_3.GetHexString(), SMALL_NUMBER_STRING_VAR_UI32 + SMALL_NUMBER_STRING_UI32);

    Ui32 zero{ZERO_STRING};
    Bytes num_4 = zero + num_2;
    EXPECT_EQ(num_4.GetHexString(), SMALL_NUMBER_STRING_VAR_UI32 + ZERO_STRING_UI32);
}

TEST_F(Ui256Test, CreateWithHexString) {
    Verify(Ui256(ZERO_STRING), ZERO_STRING_UI256, ZERO_LITTLE_ENDIAN_UI256);
    Verify(Ui256(ODD_LENGTH_STRING), ODD_LENGTH_STRING_UI256, ODD_LENGTH_NUMBER_LITTLE_ENDIAN_UI256);
    Verify(Ui256(SMALL_NUMBER_STRING), SMALL_NUMBER_STRING_UI256, SMALL_NUMBER_LITTLE_ENDIAN_UI256);
    Verify(Ui256("00000" + SMALL_NUMBER_STRING), SMALL_NUMBER_STRING_UI256, SMALL_NUMBER_LITTLE_ENDIAN_UI256);
    Verify(Ui256(BIG_NUMBER_STRING), BIG_NUMBER_STRING_UI256, BIG_NUMBER_LITTLE_ENDIAN_UI256);

    EXPECT_DEATH(Ui256{SUPER_NUMBER_STRING}, ".*");
}

TEST_F(Ui256Test, CreateWithData) {
    Verify(Ui256(ZERO_LITTLE_ENDIAN_UI256), ZERO_STRING_UI256, ZERO_LITTLE_ENDIAN_UI256);
    Verify(Ui256(ODD_LENGTH_NUMBER_LITTLE_ENDIAN_UI256), ODD_LENGTH_STRING_UI256, ODD_LENGTH_NUMBER_LITTLE_ENDIAN_UI256);
    Verify(Ui256(SMALL_NUMBER_LITTLE_ENDIAN_UI256), SMALL_NUMBER_STRING_UI256, SMALL_NUMBER_LITTLE_ENDIAN_UI256);
    Verify(Ui256(BIG_NUMBER_LITTLE_ENDIAN_UI256), BIG_NUMBER_STRING_UI256, BIG_NUMBER_LITTLE_ENDIAN_UI256);
...
TEST_F(Ui256Test, Sums) {
    ...
    Bytes num_3 = num_1 + num_2;
    EXPECT_EQ(num_3.GetHexString(), BIG_NUMBER_STRING_UI256 + SMALL_NUMBER_STRING_UI256);

    Ui256 zero{ZERO_STRING};
    Bytes num_4 = zero + num_2;
    EXPECT_EQ(num_4.GetHexString(), BIG_NUMBER_STRING_UI256 + ZERO_STRING_UI256);
}
...
TEST(MixBytesTest, Sum) {
    ...
    EXPECT_EQ(num_3.GetHexString(), BIG_NUMBER_STRING_UI256 + SMALL_NUMBER_STRING_UI32 + ZERO_STRING_NORM);    
}